 ...
 *     responses:
 *       200:
 *         description: The updated contest response by id
 *         contens:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Contest'
 ...
 *     responses:
 *       200:
 *         description: The contest has been deleted
 *       400:
 *         description: Missing id parameter
 *       404:
 *         description: The contest was not found
 ...
 * /contest/{id}/songs:
 *   get:
 *     summary: Get a contest's songs by id
 *     tags: [Contests]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *     responses:
 *       200:
 *         description: The contest's songs response by id
 *         contens:
 *           application/json:
 *             schema:
 *               type: array
 ...
 *         description: Missing id parameter
 *       404:
 *         description: The contest or the songs were not found
 *       500:
 *         description: Someting bad happened, more info in response body
 */
